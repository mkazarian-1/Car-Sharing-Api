...
INSERT INTO payments (id, status, type, rental_id, amount_to_pay,session_url,session_id)
VALUES (1, 'PAID', 'PAYMENT', 1, 1000,'https://checkout.stripe.com/1','cs_test_a1iKI1EwbZMgWe1'),
       (2, 'PENDING', 'FINE', 2, 1100,'https://checkout.stripe.com/2','cs_test_a1iKI1EwbZMgWe2');